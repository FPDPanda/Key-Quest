...
function encounter(weapon) {
  ...
  if (encounterChance <= chances[weapon][0]) {
    ...
    encounterChance > chances[weapon][0] &&
    encounterChance <= chances[weapon][0] + chances[weapon][1]
  ) {
    monster = 'ogre'
...
function setText() {
  ...
  if (monster === 'goblin') {
    ...
    encounterText.innerHTML +=
      ...
      exploreText.goblins +
      '</span>' +
      exploreText.goblinDescription +
      '</p>'
    encounterText.innerHTML += '</br>'
  } else if (monster === 'ogre') {
    encounterText.innerHTML +=
      '<p>' +
      exploreText.ogreEncounter +
      "<span class='dark-green big'>" +
      exploreText.ogre +
      '!</span><p>'
    encounterText.innerHTML += '</br>'
    encounterText.innerHTML +=
      "<p><span class='dark-green big'>" +
      exploreText.ogres +
      '</span>' +
      exploreText.ogreDescription +
      '</p>'
    encounterText.innerHTML += '</br>'
  } else {
    encounterText.innerHTML +=
      '<p>' +
      exploreText.orcEncounter +
      "<span class='white black-bg big'>" +
      exploreText.orc +
      '!</span><p>'
    encounterText.innerHTML += '</br>'
    encounterText.innerHTML +=
      "<p><span class='white black-bg big'>" +
      exploreText.orcs +
      '</span>' +
      exploreText.orcDescription +
      '</p>'
    encounterText.innerHTML += '</br>'
  }
  ...
  if (stats.health <= 1) {
    boxText.innerHTML += "<p class ='red'>" + exploreText.lowHP + '</p>'
...
function playerAttack() {
  ...
  if (chosenWeapon === 'Dagger') {
    boxText.innerHTML +=
      '<p>' +
      exploreText.playerAttackDagger +
      "<span class='grey'>" +
      exploreText.dagger +
      '!</span></p>'
    boxText.innerHTML += '<br>'
...
function lootDrop() {
  ...
  if (droppedLoot > 3) {
    boxText.innerHTML +=
      '<p>' +
      exploreText.dropCoins +
      "<span class='gold' style='font-size:20px'> " +
      exploreText.coins +
      '!</span></p>'
    boxText.innerHTML += '<br>'
