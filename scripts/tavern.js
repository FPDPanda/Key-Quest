...
window.addEventListener('load', function () {
  ...
  localStorage.getItem('visitedTavern')
    ? 0
    : localStorage.setItem('visitedTavern', JSON.stringify('visited'))
})
...
sleepButton.addEventListener('click', function () {
  ...
  if (stats.coins >= 3) {
    ...
    bubble.innerHTML +=
      "<p class='dark-blue'>" + tavernText.sleepMessage + '</p>'
    ...
    bubble.innerHTML +=
      '<p>' +
      tavernText.needCoin1 +
      (2 - stats.coins) +
      tavernText.needCoin2 +
      '</p>'
  }
